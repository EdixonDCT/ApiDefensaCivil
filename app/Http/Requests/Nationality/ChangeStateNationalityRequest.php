...
/**
 * Clase ChangeStateNationalityRequest
 * * Controla la activación o desactivación lógica de los registros de nacionalidad.
 * Esto permite deshabilitar opciones sin comprometer la integridad referencial de los perfiles.
 */
class ChangeStateNationalityRequest extends FormRequest
{
    /**
