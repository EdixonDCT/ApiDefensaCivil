...
class RegisterRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'last_name.alpha_spaces' => 'Los :attribute solo pueden contener letras y espacios.',
            'last_name.min' => 'Los :attribute deben tener al menos 3 caracteres.',
            'last_name.max' => 'Los :attribute no pueden tener más de 50 caracteres.',
