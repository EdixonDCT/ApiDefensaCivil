...
class StateStatusController extends Controller
{
    protected $service;

    public function __construct(StateStatusService $service)
    {
    ...
    public function store(StoreStateStatusRequest $request)
    {
    ...
    public function update(UpdateStateStatusRequest $request, string $id)
    {
        $data = $request->validated();
    ...
    public function partialUpdate(PartialUpdateStateStatusRequest $request, string $id)
    {
    $data = $request->validated();
